...
export default function ServicePage() {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen gap-16 p-8 mt-12 overflow-hidden text-white bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
