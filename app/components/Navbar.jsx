...
export default function Navbar() {
  ...
  const models = [
    { subName: 'VICTORIS', thumbnail: 'https://www.skyautomobiles.in/thumbnail/victoris.png', link: '/vehicles/victoris' },
    { subName: 'ALTO K10', thumbnail: 'https://www.skyautomobiles.in/thumbnail/altoK10.webp', link: '/vehicles/alto-k10' },
    { subName: 'SWIFT', thumbnail: 'https://www.skyautomobiles.in/thumbnail/swift02.webp', link: '/vehicles/swift' },
    { subName: 'BREZZA', thumbnail: 'https://www.skyautomobiles.in/thumbnail/brezza-page.webp', link: '/vehicles/brezza' },
    { subName: 'DZIRE', thumbnail: 'https://www.skyautomobiles.in/thumbnail/bluishblack.png', link: '/vehicles/dzire' },
    { subName: 'S-PRESSO', thumbnail: 'https://www.skyautomobiles.in/thumbnail/spresso.webp', link: '/vehicles/spresso' },
    { subName: 'WAGONR', thumbnail: 'https://www.skyautomobiles.in/thumbnail/wagnor.webp', link: '/vehicles/wagonr' },
    { subName: 'ERTIGA', thumbnail: 'https://www.skyautomobiles.in/thumbnail/ertiga.webp', link: '/vehicles/ertiga' },
    { subName: 'CELERIO', thumbnail: 'https://www.skyautomobiles.in/thumbnail/celerio.webp', link: '/vehicles/celerio' },
    { subName: 'EECO', thumbnail: 'https://www.skyautomobiles.in/thumbnail/Eeco.webp', link: '/vehicles/eeco' },
  ];
                ...
                <>
                  <Link href="/true-value/buy-car" onClick={closeMenus}>
                    <div className="flex flex-col items-center justify-center p-6 bg-gray-50 hover:bg-[#0E1224] hover:text-white rounded-xl shadow hover:shadow-xl transition-all duration-300">
                      ...
                      <p className="mt-2 text-sm text-center opacity-80">
                        Explore certified pre-owned cars with trust and transparency.
                      </p>
                    </div>
                  </Link>
                  <Link href="/true-value/sell-car" onClick={closeMenus}>
                    <div className="flex flex-col items-center justify-center p-6 bg-gray-50 hover:bg-[#0E1224] hover:text-white rounded-xl shadow hover:shadow-xl transition-all duration-300">
                      ...
                      <p className="mt-2 text-sm text-center opacity-80">
                        Get the best value for your car with easy evaluation & process.
                      </p>
                    </div>
                  </Link>
                </>
                    ...
                    {mobileVehicleOpen && (
                      <div className="mt-3 space-y-5">
                        ...
                        <div className="flex flex-col gap-2">
                          <Link href="/true-value/buy-car" onClick={closeMenus} className="block px-4 py-2 transition rounded-lg bg-white/10 hover:bg-white/20">
                            Buy a Car
                          </Link>
                          <Link href="/true-value/sell-car" onClick={closeMenus} className="block px-4 py-2 transition rounded-lg bg-white/10 hover:bg-white/20">
                            Sell a Car
                          </Link>
                        </div>
                      </div>
