      ...
      try {
        ...
        if (rangeValue === '') {
          ...
          response = await fetch(
            `/api/service?rangeValue=${rangeValue}&startDate=${dateRange.startDate}&endDate=${dateRange.endDate}&channel=Arena`
          );
        } else if (rangeValue !== 'Between') {
          response = await fetch(
            `/api/service?rangeValue=${rangeValue}&channel=Arena`
          );
        }
