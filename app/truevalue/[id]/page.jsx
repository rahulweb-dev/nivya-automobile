      ...
      <main className="container grid grid-cols-1 gap-10 px-4 mx-auto mt-8 lg:grid-cols-3">
        ...
        <div className="space-y-8 lg:col-span-2">
          ...
          <section className="overflow-hidden bg-white shadow-lg rounded-3xl">
            ...
            >
              {(car.gallery?.length ? car.gallery : [car.image]).map((img, i) => (
                <SwiperSlide key={i}>
                  <img
                    src={img}
                    alt={`${car.name}-${i}`}
          ...
          <section className="p-8 bg-white shadow-lg rounded-3xl">
            ...
            <div className="grid grid-cols-2 gap-5 sm:grid-cols-4">
              ...
              <OverviewItem icon={<Gauge />} label={`${formatNumber(car.kmDriven)} km`} />
            ...
            <div className="mt-10">
              ...
              <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4">
                {(car.features?.length
                  ? car.features
                  : ['Air Conditioner', 'ABS', 'Alloy Wheels', 'Bluetooth', 'Cruise Control']
                ).map((f, i) => (
                  <div
                    key={i}
            ...
            {/* DESCRIPTION */}
            <div className="mt-10">
              <h3 className="mb-2 text-xl font-semibold text-gray-900">Seller Comments</h3>
          ...
          {/* SIMILAR CARS */}
          <section>
            <h3 className="mb-5 text-2xl font-semibold text-gray-900">Similar Cars</h3>
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {similar.map((s) => (
                ...
                >
                  <img src={s.image} alt={s.name} className="object-cover w-full h-44" />
                  <div className="p-5">
                    <h4 className="font-semibold text-gray-900">{s.name}</h4>
                    <p className="text-sm text-gray-500">{s.brand} • {s.modelYear}</p>
